      ...
      <div className="border-t-2 border-zinc-900">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-4 py-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-xs text-zinc-500">
            &copy; {new Date().getFullYear()} Sneaker Hub. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-xs text-zinc-500">
            <Link to="#" className="hover:text-amber-900 hover:underline">Privacy</Link>
            <Link to="#" className="hover:text-amber-900 hover:underline">Terms</Link>
            <Link to="#" className="hover:text-amber-900 hover:underline">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
